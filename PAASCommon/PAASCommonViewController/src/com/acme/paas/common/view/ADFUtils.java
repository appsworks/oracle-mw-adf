package com.acme.paas.common.view;
...
public class ADFUtils {
    ...
    /**
     * Executes an operation binding with parameters
     * @param operationName Operation name
     * @param params Parameters
     * @return Operation binding
     */
    public static Object executeOperation(String operationName, Map<String,Object> params) {
    ...
    /**
     * Executes an operation binding
     * @param operationName Operation name
     * @return
     */
    public static Object executeOperation(String operationName){
        return executeOperation(operationName, null);
    }
     ...
     * not best practice to reference or 
     * bindings in binding containers
